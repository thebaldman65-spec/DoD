...
- **`DoD-archive/` IS IN THE REPO AS OF BATCH FH, AND IT IS THE FIRST FILE THE PICKER MUST DROP.**
  ...
  **DESELECT `DoD-archive/` — both files.** It is **1,680,660 B = 14.2% of the sync**, larger
  than every `check_*.gd` in the tree put together, and the sync reads 11.3106 MiB with it and
  **9.7078 MiB without it — exactly where it stood before FH.**
