...
const FIXED_TREES := {
	...
	"cryomancer": [
		...
		{"id": "cr_frostbite", "name": "Frostbite", "ranks": 3, "row": 0, "col": 2,
			"gate": "row", "requires": "", "requires_ranks": 0,
		...
		{"id": "cr_rime", "name": "Rime", "ranks": 1, "row": 1, "col": 2,
			"gate": "row", "requires": "", "requires_ranks": 0,
			"desc": "New ability: Rime — for 3 turns, every stack of Chilled the target gains also chills one other random enemy (25 Mana, 3.0 int, 3cd).",
			"payload": {"new_ability": {"display_name": "Rime", "cost": 25,
				...
				"description": "Hoarfrost takes root: for 3 turns,\nevery stack of Chilled this enemy\ngains also chills one other random\nenemy."}}},
