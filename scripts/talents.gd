...
const POOLS := {
	"berserker": [
		...
		{"id": "b3", "tier": 3, "ranks": 2, "requires": "b1", "name": "Iron Fury",
			"desc": "+16 Stability per rank.", "payload": {"stat": {"stability": 16}}},
	...
	"warden": [
		...
		{"id": "w2", "tier": 2, "ranks": 2, "requires": "", "name": "Immovable",
			"desc": "+20 Stability per rank.", "payload": {"stat": {"stability": 20}}},
	...
	"beastmaster": [
		{"id": "bm1", "tier": 2, "ranks": 2, "requires": "", "name": "Barbed Tips",
	...
	"mystic": [
		{"id": "my1", "tier": 2, "ranks": 2, "requires": "", "name": "Bigger Powder Charge",
			"desc": "Explosive Shot deals +2 damage per rank.",
			"payload": {"ability": "Explosive Shot", "add": {"damage": 2}}},
		{"id": "my2", "tier": 5, "ranks": 1, "requires": "", "name": "Serrated Blade",
			"desc": "Gut builds +10 more Bleed.",
			"payload": {"ability": "Gut", "add": {"bleed_build": 10}}},
	],
	"occultist": [
		...
		{"id": "o3", "tier": 4, "ranks": 1, "requires": "", "name": "Whispering Madness",
...
const FILLER_DEFS := [
	...
	["stability", "+%d Stability per rank", 8],
