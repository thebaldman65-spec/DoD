...
static func warrior_kit() -> Array:
	return [
		...
		Ability.make({"display_name": "Heavy Strike", "cost": 30, "damage": 50, "pressure": 15,
			"delay": 4.0, "anim": "attack02",
			"perfect_id": "pressure", "perfect_text": "+60% Pressure",
			"description": "Big single-target damage."}),
		Ability.make({"display_name": "Crushing Blow", "cost": 20, "damage": 32, "pressure": 17,
		...
		"swordmaster":
			return [
				...
				Ability.make({"display_name": "Momentum", "cost": 25, "damage": 20,
					"pressure": 24, "delay": 3.5, "anim": "attack03",
					"perfect_id": "pressure", "perfect_text": "+60% Pressure",
